...
/usr/bin/python /home/pi/blynk-library/scripts/blynk_ctrl.py -s sonospi.local -p 8442 -t $SONOSPI_TOKEN -vw $IDLE_VPIN 0
/usr/bin/python /home/pi/blynk-library/scripts/blynk_ctrl.py -s sonospi.local -p 8442 -t $SONOSPI_TOKEN -vw $SWITCH_VPIN 0
